	...
	return (
		<>
			<div className="purchase-box col-10 col-md-5 col-xl-5">
				...
				<a target='_blank' href='https://allegro.pl/oferta/100-ochronnych-masek-cywilnych-4-warstwy-9161209385' className="purchase-box__btn">Buy Now</a>
			</div>
			<div className="purchase-box col-10 col-md-5 col-xl-5">
				...
				<a target='_blank' href={'https://allegro.pl/oferta/mydlo-antybakteryjne-w-plynie-10x1l-atest-9225069930'} className="purchase-box__btn">Buy Now</a>
			</div>
		</>
	)
